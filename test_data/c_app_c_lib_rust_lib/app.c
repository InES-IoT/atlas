// Compile with:
// ```
// rustc -O --crate-type staticlib --target thumbv7em-none-eabi --out-dir libs rust_lib.rs
// arm-none-eabi-gcc -march=armv7e-m -c c_lib.c -o libs/c_lib.o
// ar rcs libs/libc_lib.a libs/c_lib.o
// arm-none-eabi-gcc -march=armv7e-m app.c -Llibs -lrust_lib -lc_lib --specs=nosys.specs -o app
// ```
// Print symbols with `arm-none-eabi-nm --print-size --size-sort --demangle app`

extern int c_add(int a, int b);
extern int c_triple_mult(int a, int b, int c);
